...
//  Complexity
//
//  Created by Filipi Nascimento Silva on 25/Dec/15.
//  Copyright (c) 2012 Filipi Nascimento Silva. All rights reserved.
//

#ifndef CXComplexity_Commons_h
#define CXComplexity_Commons_h
...
#define kCXDefaultParallelBlocks 8
...
CV_INLINE CVString CVNewStringFromFormat(const CVString format, ...){
	va_list arglist;
	va_start(arglist,format);
	CVString returnedString = NULL;
	asprintf(&returnedString,format,arglist);
	va_end(arglist);
